...
env="aps"
algo="mappo"
exp="test/partial_olp_pretrained_ev/ap20_ue6_sinr0_offaps0/veh_10step_50ms/gnnmappo/localpsum1_sumcost0_conncost1_pcoef5"
seed=1
python train_aps.py --use_valuenorm --env_name ${env} --algorithm_name ${algo} \
 ...
 --entropy_coef 0.1 # --model_dir /home/mzi/aps-infomarl/onpolicy/results/aps/mappo/init/partial_olp/ap20_ue6_sinr0_offaps0/run1/models
