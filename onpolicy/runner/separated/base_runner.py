...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            ...
            from onpolicy.algorithms.happo.happo_policy import HAPPO_Policy as Policy
        else:
            raise NotImplementedError("Algorithm {} is not implemented.".format(self.all_args.algorithm_name))
